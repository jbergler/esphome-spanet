...
public:
  ...
  void set_controller_model_sensor(text_sensor::TextSensor *sensor) {
    this->sen_controller_model_ = sensor;
  }
  void set_controller_serial_sensor(text_sensor::TextSensor *sensor) {
    this->sen_controller_serial_ = sensor;
  }
  ...
  void set_water_temperature_sensor(sensor::Sensor *sensor) {
    this->sen_water_temperature_ = sensor;
  }
  void set_setpoint_temperature_sensor(sensor::Sensor *sensor) {
    this->sen_setpoint_temperature_ = sensor;
  }
  void set_heater_temperature_sensor(sensor::Sensor *sensor) {
    this->sen_heater_temperature_ = sensor;
  }
  void set_case_temperature_sensor(sensor::Sensor *sensor) {
    this->sen_case_temperature_ = sensor;
  }
  void set_mains_voltage_sensor(sensor::Sensor *sensor) {
    this->sen_mains_voltage_ = sensor;
  }
  void set_mains_current_sensor(sensor::Sensor *sensor) {
    this->sen_mains_current_ = sensor;
  }
  void set_instant_power_sensor(sensor::Sensor *sensor) {
    this->sen_instant_power_ = sensor;
  }
  void set_total_energy_sensor(sensor::Sensor *sensor) {
    this->sen_total_energy_ = sensor;
  }
  void add_on_state_callback(StateUpdateCallback callback) {
